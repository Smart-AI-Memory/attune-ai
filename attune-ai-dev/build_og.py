...
``discipline/index.html`` as ``https://attune-ai.dev/og.png`` and cached via
...
def main() -> int:
    ...
    d.text((pad, 175), "attune-ai", font=title, fill=INK)
    ...
    d.text((pad, 525), "attune-ai.dev", font=foot, fill=ACCENT)
