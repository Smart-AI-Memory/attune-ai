---
name: fix-test
description: "Auto-diagnose and fix failing tests. Identifies root causes (mock mismatches, assertion drift, import errors, etc.), applies fixes, and re-runs to verify — up to 3 attempts per test. Triggers on: fix test, fix failing test, test failure, broken test, test error, why is this test failing, debug test."
