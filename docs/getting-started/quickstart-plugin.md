...
The plugin ships <!-- cap:skill_count -->**29 auto-triggering skills**<!-- /cap -->. You don't memorize commands —
...
!!! note "Plugin vs. package"
    The **plugin** gives you the <!-- cap:skill_count -->29 natural-language skills<!-- /cap --> with zero setup.
