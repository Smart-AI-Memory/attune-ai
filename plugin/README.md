...
**Version:** 16.3.0 | **License:** Apache 2.0
...
for CLI automation, <!-- cap:mcp_registered_tool_count -->66 MCP tools<!-- /cap -->, multi-agent
...
| <!-- cap:mcp_registered_tool_count -->66 MCP tools<!-- /cap --> | -- | Yes |
| `attune` CLI | -- | Yes |
