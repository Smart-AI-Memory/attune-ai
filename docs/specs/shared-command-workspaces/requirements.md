...
**Status:** requirements approved (2026-08-31) — the chair promoted
all seven round-table candidates and raised this initiative's changed-code
coverage requirement to 90%. Design and tasks are authored for review;
