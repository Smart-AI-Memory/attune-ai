...
Reads and integrates Claude Code's CLAUDE.md memory files with the Attune AI.
...
def create_default_project_memory(project_root: str, framework: str = "empathy"):
    ...
    if framework.lower() == "empathy":
        default_content = """# Project Memory: Attune AI

## Project Context
This project uses the Attune AI for AI-powered software development assistance.
