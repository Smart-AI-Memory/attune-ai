...
- **License Text:** See [LICENSES/MIT.txt](LICENSES/MIT.txt)
...
- **License Text:** See [LICENSES/Apache-2.0.txt](LICENSES/Apache-2.0.txt) or [LICENSES/MIT.txt](LICENSES/MIT.txt)
...
- **License Text:** See [LICENSES/Apache-2.0.txt](LICENSES/Apache-2.0.txt)
...
The full text of the licenses mentioned above can be found in the [LICENSES/](LICENSES/) directory:
...
- [website/package.json](website/package.json) - Node.js dependencies (for website)
