...
When we built Attune AI, we started with a simple principle:
...
Attune AI uses a three-tier memory system, each optimized for different use cases:

### Long-Term Memory

**What it is:** Git-based persistent storage for patterns, decisions, and context that should survive across sessions, projects, and even team members. This functionality is built directly into Attune AI.
...
Install Attune AI with memory support:
...
That's what we're building with Attune AI.

---

*Want to learn more? Check out our [documentation](/docs) or join the discussion on [GitHub](https://github.com/Smart-AI-Memory/attune-ai/discussions).*

*Building something with Attune AI's memory system? We'd love to hear about it—[get in touch](/contact).*
