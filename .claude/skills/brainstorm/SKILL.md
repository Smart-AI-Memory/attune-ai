...
category: primary
aliases: [bs, think]
tags: [brainstorm, discovery, planning, ideation]
version: "1.0.0"
question:
  header: "What's on your mind?"
  question: "What are you working on or thinking through?"
  multiSelect: false
  options:
    - label: "Exploring a new idea"
      description: "Something I want to build, add, or try"
    - label: "Solving a problem"
      description: "Something broken, slow, or not working right"
    - label: "Planning an approach"
      description: "I know what I want but need to figure out how"
    - label: "Expanding scope"
      description: "Something exists but I want to take it further"
---
