...
| Add the full MCP toolset <!-- cap:mcp_registered_tool_count -->(64 tools)<!-- /cap --> + CLI | [MCP Integration](mcp-integration.md) |
...
!!! note "Plugin vs. package"
    ...
    `attune` CLI, the MCP server, and <!-- cap:mcp_registered_tool_count -->64 MCP tools<!-- /cap --> on top. You can start with
