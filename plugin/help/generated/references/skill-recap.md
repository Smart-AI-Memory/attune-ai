...
category: skill
tags: [skill, plugin]
source: plugin/skills/recap/SKILL.md
---

# Reference: Skill: recap

Structured end-of-session review — what shipped, where the time went, lessons, risks, open items — then persist the cross-session handoff starter. Triggers on: recap, end of session review, session retro, wrap up, what did we get done today.
