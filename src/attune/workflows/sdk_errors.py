...
``agent_sdk_adapter`` re-exports every public name here, so existing
imports keep working; tests that monkeypatch the probe/classifier
should target THIS module (the defining namespace).
