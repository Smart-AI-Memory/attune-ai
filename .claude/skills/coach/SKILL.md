---
name: coach
description: "Progressive help for any topic. Repeat to go deeper: concept -> procedural -> reference."
...
The engine auto-advances on each call: first call
returns concept, second returns procedural, third
returns reference. Saying "tell me more" or repeating
`/coach <topic>` both advance to the next level.
...
same topic again — the engine auto-advances.
