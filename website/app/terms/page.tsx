...
export const metadata: Metadata = generateMetadata({
  ...
  description: 'Terms of service for Smart AI Memory and Attune AI.',
        ...
        <section className="py-20">
          <div className="container">
            <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <p>
                By accessing our website at smartaimemory.com or using Attune AI
              ...
              <p>
                Attune AI, documentation, and website content are owned by
                Smart AI Memory and protected by copyright, trademark, and other intellectual property laws.
              </p>

              <h3>5.2 Your Content</h3>
              <p>
                You retain all rights to content you create using Attune AI.
                We claim no ownership over your code, data, or projects created with our tools.
              </p>

              <h2>6. Third-Party Services</h2>
              <p>
                Attune AI integrates with third-party LLM providers (Anthropic, OpenAI, Google, etc.).
              ...
              <p>
                Attune AI uses AI models that may produce:
              </p>
              <ul>
              ...
              <p>
                <strong>Important Notice:</strong> While Attune AI includes healthcare wizards,
              ...
              <p className="text-sm text-gray-600">
                By using Attune AI or our Services, you acknowledge that you have read,
