...
- Byte budget: `FORM_THEME_CSS` ≤ 16 KB raw (most recently amended
  from 12 KB — chair-ratified 2026-08-30 for the project path-picker
  family, landed with #2382 on 2026-08-31, and re-confirmed the same
  day for attune-forms 0.11.1 whose expanded grammar theme measures
  14,926 B — see the spec's decisions.md), enforced by a
  residency-style drift test
