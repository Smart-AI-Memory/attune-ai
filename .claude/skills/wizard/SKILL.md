...
category: primary
aliases: [wiz]
tags: [wizard, guided, xml, tasks, multi-step]
version: "1.0.0"
question:
  header: "Wizard"
  question: "What wizard operation do you need?"
  multiSelect: false
  options:
    - label: "Run a wizard"
      description: "Execute a guided multi-step wizard"
    - label: "Create a wizard"
      description: "Define a new custom wizard"
    - label: "List wizards"
      description: "Show available wizards"
    - label: "Edit a wizard"
      description: "Modify an existing wizard"
---
