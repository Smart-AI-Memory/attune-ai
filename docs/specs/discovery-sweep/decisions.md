...
**Resolved 2026-05-13 (Phase 1):** Severity ≥ medium → eligible for queue, severity < medium (low / info) → rejected, location-missing → questions. Matches the initial guess; revisit after first dogfood run.
