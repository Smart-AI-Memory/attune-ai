...
export ATTUNE_WORKFLOW_CACHE_TTL=1800  # 30 minutes
...
```bash
# Disable specific caches
ATTUNE_DISABLE_PATTERN_CACHE=1
ATTUNE_DISABLE_WORKFLOW_CACHE=1

# Adjust sizes
ATTUNE_AST_CACHE_SIZE=3000
ATTUNE_PATTERN_CACHE_SIZE=2000

# TTL configuration
ATTUNE_WORKFLOW_CACHE_TTL=3600
ATTUNE_PATTERN_CACHE_TTL=1800
```
