...
class TestProgressWidget:
    ...
    def test_submit_script_handles_progress(self) -> None:
        # forms 0.7.0: the blocked-item picker answers like a single-select,
        # so it reads through the "checked-one" mode (the reader dispatches
        # on data-collect, not construct type).
        html = form_to_widget_html(form_from_dict(_progress()))
