---
name: smart-test
description: "Find test gaps and generate tests for uncovered code. Analyzes coverage, identifies untested public APIs, and generates pytest tests with edge cases. Triggers on: generate tests, write tests, test coverage, find untested code, test gaps, smart test, what needs testing."
